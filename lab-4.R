...
t.test(a,b, paired = FALSE, var.equal = TRUE)# ali sta razpršenosti dveh vzorcev enaki
...
var.test(a, b)#p vrednost je zelo majhna; varianca vzorca a je različna od vzorca b
